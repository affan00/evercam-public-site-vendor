...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Evercam -  Use Cases</title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="keywords" content="cameras, use cases, sap, integration, apps, recording, remote storage, sharing, api, developer platform">
    ...
    <section id="weighbridge">
      <div class="use-case-features">
        <div class="use-case-feature">
          ...
          <p>
            Together with <a href="http://www.neoris.com/en/" target="_blank">Neoris</a>, a leading solution extender for MII, we’ve taken advantage of this new feature to enable camera integration.
          </p>
          <p>
