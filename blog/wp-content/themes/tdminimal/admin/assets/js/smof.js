...
jQuery(document).ready(function($){
	...
	//Add new slider (extended)
	$(".slider_extended_add_button").on('click', function(){		
		var slidesContainer = $(this).prev();
		var sliderId = slidesContainer.attr('id');
		...
		var newSlide = '<li class="temphide"><div class="slide_header"><strong>Slide ' + newNum + '</strong><input type="hidden" class="slide of-input order" name="' + sliderId + '[' + newNum + '][order]" id="' + sliderId + '_slide_order-' + newNum + '" value="' + newNum + '"><a class="slide_edit_button" href="#">Edit</a></div><div class="slide_body" style="display: none; "><label>Title</label><input class="slide of-input of-slider-title" name="' + sliderId + '[' + newNum + '][title]" id="' + sliderId + '_' + newNum + '_slide_title" value=""><label>Image URL</label><input class="upload slide of-input" name="' + sliderId + '[' + newNum + '][url]" id="' + sliderId + '_' + newNum + '_slide_url" value=""><div class="upload_button_div"><span class="button media_upload_button" id="' + sliderId + '_' + newNum + '">Upload</span><span class="button remove-image hide" id="reset_' + sliderId + '_' + newNum + '" title="' + sliderId + '_' + newNum + '">Remove</span></div><div class="screenshot"></div><label>Link URL (optional)</label><input class="slide of-input" name="' + sliderId + '[' + newNum + '][link]" id="' + sliderId + '_' + newNum + '_slide_link" value=""><label>Link CTA (optional)</label><input class="slide of-input" name="' + sliderId + '[' + newNum + '][cta]" id="' + sliderId + '_' + newNum + '_slide_cta" value=""><label>Description (optional)</label><textarea class="slide of-input" name="' + sliderId + '[' + newNum + '][description]" id="' + sliderId + '_' + newNum + '_slide_description" cols="8" rows="8"></textarea><label>Caption</label><div class="option"><div class="controls"><div class="select_wrapper mini" style="width: 120px;"><select class="select of-input" name="' + sliderId + '[' + newNum + '][caption_align]" id="' + sliderId + '_' + newNum + '_slide_caption_align"><option value="" selected="selected">Left</option><option value="right">Right</option><option value="center">Center</option></select><a class="slide_delete_button" href="#">Delete</a><div class="clear"></div></div></li>';
	...
	//Add new slider (home page slideshow)
	$(".featured_slider_add_button").on('click', function(){		
		var slidesContainer = $(this).prev();
		var sliderId = slidesContainer.attr('id');
		...
		var newSlide = '<li class="temphide"><div class="slide_header"><strong>Slide ' + newNum + '</strong><input type="hidden" class="slide of-input order" name="' + sliderId + '[' + newNum + '][order]" id="' + sliderId + '_slide_order-' + newNum + '" value="' + newNum + '"><a class="slide_edit_button" href="#">Edit</a></div><div class="slide_body" style="display: none; "><label>Title</label><input class="slide of-input of-slider-title" name="' + sliderId + '[' + newNum + '][title]" id="' + sliderId + '_' + newNum + '_slide_title" value=""><label>Image URL</label><input class="upload slide of-input" name="' + sliderId + '[' + newNum + '][url]" id="' + sliderId + '_' + newNum + '_slide_url" value=""><div class="upload_button_div"><span class="button media_upload_button" id="' + sliderId + '_' + newNum + '">Upload</span><span class="button remove-image hide" id="reset_' + sliderId + '_' + newNum + '" title="' + sliderId + '_' + newNum + '">Remove</span></div><div class="screenshot"></div><label>Embed Video</label><textarea class="slide of-input" name="' + sliderId + '[' + newNum + '][embed_video]" id="' + sliderId + '_' + newNum + '_slide_embed_video" cols="8" rows="8"></textarea><label>Link URL (optional)</label><input class="slide of-input" name="' + sliderId + '[' + newNum + '][link]" id="' + sliderId + '_' + newNum + '_slide_link" value=""><label>Link CTA (optional)</label><input class="slide of-input" name="' + sliderId + '[' + newNum + '][cta]" id="' + sliderId + '_' + newNum + '_slide_cta" value=""><label>Description (optional)</label><textarea class="slide of-input" name="' + sliderId + '[' + newNum + '][description]" id="' + sliderId + '_' + newNum + '_slide_description" cols="8" rows="8"></textarea><label>Caption</label><div class="option"><div class="controls"><div class="select_wrapper mini" style="width: 120px;"><select class="select of-input" name="' + sliderId + '[' + newNum + '][caption_align]" id="' + sliderId + '_' + newNum + '_slide_caption_align"><option value="" selected="selected">Left Align</option><option value="right">Right Align</option><option value="center">Full Width</option><option value="none">Hide</option></select></div></div></div><a class="slide_delete_button" href="#">Delete</a><div class="clear"></div></div></li>';
	...
	//Add new section for blog posts
	$(".posts_add_button").on('click', function(){		
		var slidesContainer = $(this).prev();
		var sliderId = slidesContainer.attr('id');
		...
		var newSlide = '<li class="temphide"><div class="slide_header"><strong>Section ' + newNum + '</strong><input type="hidden" class="slide of-input order" name="' + sliderId + '[' + newNum + '][order]" id="' + sliderId + '_slide_order-' + newNum + '" value="' + newNum + '"><a class="slide_edit_button" href="#">Edit</a></div><div class="slide_body" style="display: none; "><label>Title</label><input class="slide of-input of-slider-title" name="' + sliderId + '[' + newNum + '][title]" id="' + sliderId + '_' + newNum + '_slide_title" value=""><label>Category ID</label><input class="slide of-input" name="' + sliderId + '[' + newNum + '][cat_id]" id="' + sliderId + '_' + newNum + '_slide_cat_id" value=""><label>Posts Per Page</label><input class="slide of-input of-slider-per-page" name="' + sliderId + '[' + newNum + '][per_page]" id="' + sliderId + '_' + newNum + '_slide_per_page" value=""><div><label>Post Summary</label><div class="option"><div class="controls"><div class="select_wrapper mini" style="width: 120px;"><select class="select of-input" name="' + sliderId + '[' + newNum + '][summary]" id="' + sliderId + '_' + newNum + '_slide_summary"><option value="" selected="selected">Off</option><option value="1">On</option></select></div></div></div></div><div><label>Layout</label><div class="option"><div class="controls"><div class="select_wrapper mini" style="width: 220px;"><select class="select of-input" name="' + sliderId + '[' + newNum + '][post_layout]" id="' + sliderId + '_' + newNum + '_slide_post_layout"><option value="one-column">One Column</option><option value="one-column-alt">One Column (Alt)</option><option value="two-columns" selected="selected">Two Columns</option><option value="three-columns">Three Columns</option><option value="standard">Standard</option></select></div></div></div></div><a class="slide_delete_button" href="#">Delete</a><div class="clear"></div></div></li>';
	...
	//Add new simple slide
	$(".simple_slider_add_button").on('click', function(){		
		var slidesContainer = $(this).prev();
		var sliderId = slidesContainer.attr('id');
