	...
	<div id="primary" class="content-area">
		<div id="content" class="site-content" role="main">
			<div class="wrap">
						...
						<div id="sidebar">
							<div class="top-sidebar"><h3>Categories</h3>
							<a href="/ecblog">All</a>
		...
		<div id="left-content">
			<header class="page-header">
					...
					<h1 class="page-title">
						<?php
							if ( is_category() ) :
								printf( __( 'Archives | %s', 'ryu' ), '<span>' . single_cat_title( '', false ) . '</span>' );
							...
							elseif ( is_author() ) :
								...
								*/
								the_post();
								printf( __( 'By Author | %s', 'ryu' ), '<span class="vcard"><a class="url fn n" href="' . esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ) . '" title="' . esc_attr( get_the_author() ) . '" rel="me">' . get_the_author() . '</a></span>' );
