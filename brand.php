...
<body id="brand">
  ...
  <div class="alt-color">
    <section>
      <h1>Evercam Logos</h1>
      <a class="btn" href="../brand-assets/brand-assets.zip" download>Download All Assets <i class="fa fa-download"></i></a>
    ...
    <div class="red-dot">
      ...
      <div class="row">
        <div class="logo-card">
          ...
          <a class="btn" href="../brand-assets/evercam_red_dot-500x500.png" download>PNG 500x500px <i class="fa fa-download"></i></a>
        </div>
        <div class="logo-card">
          <div class="col-md-12">
            <div class="logo-card">
