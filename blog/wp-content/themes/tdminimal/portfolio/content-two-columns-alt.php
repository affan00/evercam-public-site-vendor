<?php 
/**
 * Two Columns (Alternative) Portfolio Layout
 *
 * @package tdminimal
 */
?>

<div class="hentry-container col-lg-6 col-md-6 portfolio-archive-item<?php echo tdminimal_portfolio_post_filter_classes( get_the_ID() ); ?>">
