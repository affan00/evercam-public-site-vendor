...
<head>
  ...
  <link rel="canonical" href="http://www.evercam.io/develop"/>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta name="description" content="Evercam for developers. How to use get started and get using our API.">
...
<div class="container" id="develop-container">
...
<!-- DOCS
  ================================================== -->
<div id="develop" class='col-md-10'>
    ...
    <!-- Home Section -->
      <div class="container">
        <div class="row">
                  ...
                  <div class="row" id="develop-features">
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="row split-features-top">
                          ...
                          <div class="col-md-6">
                              ...
                              <div class="row">                     
                                  ...
                                  <div class="col-md-4 sep">
                                    <img class="img-responsive" src="../img/sepofconcerns.png">
                                  </div>
                              </div>
                              <a href="/connect" target="_blank">evercam.io<span class="bold">/connect</span></a>
                          </div>          
                      ...
                      <div class="row split-features">
                           ...
                           <p class="develop-features">Lots of Wrappers</p>   
                            <div class="row">                     
                                ...
                                <div class="col-md-2 sep">
                                  ...
                                  <a href="https://github.com/evercam/evercam.node" target="_blank" title="Node"><img src="/img/node.png" height="40" alt="Nodejs"></a>
                                  </div>
                                  <div class="col-md-2 sep">
                        ...
                        <div class="col-md-6">
                           <p class="develop-features">Awesome support</p>                             
                           <p class="margin-right-30">We'll always be on hand to support you in your project. Just drop us a mail or click the icon that you'll find in the bottom right of the page.</p>
                          <p><span class="bold">Support@evercam.io</span> or <a class="bold" href="mailto:ciaran@evercam.io" data-uv-trigger>Click here</a>!</p>
                        </div>
  ...
  <div class="row footer">
    <div class='col-sm-12'>
      ...
      <!--<p class="margin-top-15 size-12">View Our Future<a href="#" target="_blank"> Pricing Plans</a></p>-->
        ...
        <!--<div class='col-sm-8'>
          <h5>Need Help?</h5> 
          <p>We&apos;re always happy to help out with any technical questions or issues your having getting started. To get in touch <a href="mailto:ciaran@evercam.io" data-uv-trigger>click here</a> or you can email us at support@evercam.io.</p><p>Alternatively, visit our <a href="/help"><span class="bold">/help</span></a> pages for common issues.</p>
          <br />
          <h5>Get my Camera Connected</h5>
          <p> Sometimes its difficult to get your camera connected. We know that better than anyone. We&apos;ve done our best to try make getting you set up as easy as possible but if your still having trouble getting your camera connected - we can do it for you. For €20 we will get you connected. If we can&apos;t, we&apos;ll give you your money back. Simple
        </div>
