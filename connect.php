...
<html lang="en">
  <head>
    ...
    <link rel="canonical" href="http://www.evercam.io/connect"/>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Get more from your camera. Connect it to Evercam and take advantage of a marketplace of apps or work with a developer to get your camera to do more for your business.">
    <meta name="author" content="">

<title>evercam.io/connect</title>
<? include 'styles.php'; ?>
</head>
            ...
            <div class="content">
              ...
              <div class="row develop-how">
                <div class="col-md-12">
                  ...
                  <div class="col-md-4">
                      <div class="col-md-3"><i class="fa fa-user fa-3x"></i></div>
                      <div class="col-md-9">Create a free evercam.io account.</div>
                  ...
                  <div class="col-md-4">
                    <div class="col-md-3"><i class="fa fa-camera fa-3x"></i></div>
                     <div class="col-md-9">Add your Camera to your account.</div>
                      <!--<div class="row buttom">
                  ...
                  <div class="col-md-4">
                    <div class="col-md-3"><i class="fa fa-unlock fa-3x"></i></div>
                    <div class="col-md-9">Add apps to your Camera &amp; share access to developers.</div>
                      <!--<div class="row buttom">
