  ...
  <header>
    <div class="banner">
      ...
      <div class="banner-image">
        <img src="http://www.evercam.io/img/browser-border.svg">          
      </div>
      <div class="phone"><img src="http://www.evercam.io/img/phone.jpg"></div>
      <div class="desktop">
        <video width="778" height="438" autoplay loop>
        <source src="http://www.evercam.io/img/dash.mp4" type="video/mp4">
      ...
      <div class="use-cases">        
        <div class="title">
          ...
          <div class="title-image">
            <img src="http://www.evercam.io/img/stephens-green-cam.jpg">
          </div>
        </div>
        <div class="gallery">          
          <div class="use-case">
              ...
              <div class="card-inner">
                <div class="row">
                  <div class="add-camera-mobile-description">
                    ...
                    <a href="https://play.google.com/store/apps/details?id=io.evercam.capture&hl=en" target="_blank"><img src="http://www.evercam.io/img/google_play_download.png" alt="Get it on Google Play"></a>
                  </div>
                </div>
              </div>
            </div> 
