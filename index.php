...
<html lang="en">
  <head>
    ...
    <link rel="canonical" href="http://www.evercam.io"/>
    <meta charset="utf-8">
      ...
      <div class="wrapper">
        <div class="container">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
             <a class="btn" id="create-account" href="https://dash.evercam.io/v1/users/signup">Create an Account</a>
           </div>
  ...
  <div class="container">
   <div class="row left">
      <div class="col-md-6 col-sm-6 col-xs-12" id="agnostic">
        ...
        <p>If we don't already support it, just let us know and we'll add it.</p>
        <!--<a class="btn" href="#"><span class="icon-resize-full"></span>MORE DETAILS</a>-->
      </div>
      <div class="col-md-6 col-sm-6 col-xs-12">
