  ...
  <? include 'nav.php'; ?>
    <header>
      <div class="banner">
        ...
        <div class="app-image">
          <img src="http://www.evercam.io/img/connected-camera.svg">
        </div>
      </div>
    </header>
    <div class="alt-color">
      <main>
        <div class="apps">
          <div class="cards">
            ...
            <a href="https://play.google.com/store/apps/details?id=io.evercam.bigredsnapshot" target="_blank">
            <div class="card">
              <div class="card-inner">
            ...
            <a href="http://selfies.evercam.io/" target="_blank">
            <div class="card">
              <div class="card-inner">
