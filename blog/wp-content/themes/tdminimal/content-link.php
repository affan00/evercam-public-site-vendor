...
<div class="hentry-container hentry-link-container col-lg-6 col-md-6 post-box">
<?php elseif( tdminimal_is_three_columns_layout() ): ?>
<div class="hentry-container col-lg-4 col-md-4 col-sm-4 post-box">
<?php else: ?>
<div class="hentry-container hentry-link-container col-lg-12 col-md-12 post-box">
<?php endif; ?>
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<header class="entry-header">
			...
			<div class="post-thumb">
				...
				<a href="<?php the_permalink(); ?>" class="thumb-mask-link-icon" alt="<?php the_title(); ?>"><i class="icon-link"></i></a>
			</div><!-- .post-thumb -->
			<?php endif; ?>
